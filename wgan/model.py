...
class Discriminator(nn.Module):
    def __init__(self, channels_img, features_d):
        ...
        self.disc = nn.Sequential(
            ...
            # we want the last layer to be 1x1 because it classifies true/false
        )
    ...
    def _block(self, in_channels, out_channels, kernel_size, stride, padding):
        return nn.Sequential(
            ...
            # affine means that parameters can learn
            nn.InstanceNorm2d(out_channels, affine=True), # used in wgan-gradient penalty
            nn.LeakyReLU(0.2)
        )
...
class Generator(nn.Module):
    def __init__(self, channels_noise, channels_img, features_g):
        ...
        self.gen = nn.Sequential(
            ...
            nn.Tanh(), # forces image to be between range [-1, 1] to make valid image
        )
